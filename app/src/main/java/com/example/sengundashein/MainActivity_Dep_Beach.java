...
public class MainActivity_Dep_Beach extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_dep_beach);

        txt_name = (TextView) findViewById(R.id.txt_view_name_Beach);
