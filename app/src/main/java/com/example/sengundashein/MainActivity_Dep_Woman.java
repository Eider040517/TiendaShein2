...
public class MainActivity_Dep_Woman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_dep_woman);

        txt_name = (TextView) findViewById(R.id.txt_view_name_woman);
